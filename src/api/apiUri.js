...
const apiUri = {
  ...
  user: {
    ...
    nextId:  ()   => `${portal}/portal/users/next-id`,
  },
  dept: {
  ...
  code: {
    ...
    nextId:    ()     => `${portal}/portal/codes/next-id`,
  },
  schedule: {
    list:   ()   => `${portal}/portal/schedules`,
    detail: (id) => `${portal}/portal/schedules/${id}`,
    create: ()   => `${portal}/portal/schedules`,
    update: (id) => `${portal}/portal/schedules/${id}`,
    delete: (id) => `${portal}/portal/schedules/${id}`,
    run:    (id) => `${portal}/portal/schedules/${id}/run`,
  },
  envSetting: {
    list:   ()    => `${portal}/portal/env-settings`,
    detail: (key) => `${portal}/portal/env-settings/${key}`,
    update: (key) => `${portal}/portal/env-settings/${key}`,
    bulk:   ()    => `${portal}/portal/env-settings/bulk`,
  },
  notice: {
